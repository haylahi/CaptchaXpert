...
model_path = os.path.join(os.path.dirname(__file__), 'viefaucet.onnx')
model = onnxruntime.InferenceSession(model_path)
class_names = ['1', '10', '11', '2', '3', '4', '5', '6', '7', '8', '9', 'ant', 'cat', 'cow', 'dog',
               'elephant', 'fox', 'lion', 'monkey', 'mouse', 'arbitary', 'arbitary', 'tiger', 'arbitary', 'arbitary']


def predict(img: str or np.Arrayterator, n=1, scores=False):
    """
