...
def install(
    ...
    dir_assets = os.path.join(os.path.dirname(__file__), "datas", "models", "_assets")
    dir_models = os.path.join(os.path.dirname(__file__), "datas", "models")
    path_objects_yaml = os.path.join(os.path.dirname(__file__), "datas", "objects.yaml")
